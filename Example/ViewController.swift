    ...
    override func viewDidLoad() {
        ...
        for (index, imageView) in imageViews.enumerated() {
            ...
            case 2:
                ...
                galleryItem = GalleryItem.video(fetchPreviewImageBlock: { $0(UIImage(named: "2")!) }, fetchVideoBlock: { $0(AVAsset(url: URL(string: "http://video.dailymail.co.uk/video/mol/test/2016/09/21/5739239377694275356/1024x576_MP4_5739239377694275356.mp4")!)) } )
